...
MarkBox.prototype = {
    ...
    createMarkBox: function(w, h) {
        ...
        if (flag) {
            ...
            var html = "<div style='line-height:40px;height:40px;padding-left:10px;width:" + w + ";background:#fff;'><span style='text-align: center;display:block;'>" + this.title + "</span><span id='closeId' style='float:right;position: absolute;color: #dd514c;line-height:40px;top:5px;right:5px;cursor:pointer'>关闭</span></div>";
